...
# Add python user base packages to path (like pipenv)
export PATH="~/.local/bin:$PATH"

# bash prompt
PROMPT_DIRTRIM=2
PS1='\[\033[0;36m\]\u: \[\033[1;33m\]\w \[\033[0;36m\]> '

# add timestamp to bashhistory
HISTTIMEFORMAT="%F $T "
...
alias home='xrandr --output DP2-1 --mode 1920x1080 --output eDP1 --off'
